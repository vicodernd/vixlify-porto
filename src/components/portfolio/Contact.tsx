    ...
    <section id="contact" className="relative py-28 sm:py-40 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 text-center">
        ...
        <RevealOnView delay={700} className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href="mailto:hello@vixlify.studio"
            className="group relative inline-flex items-center gap-3 rounded-full bg-white px-7 py-4 text-sm font-semibold uppercase tracking-wider text-[#05070f] glow-cyan transition-transform hover:scale-[1.03]"
          >
            hello@vixlify.studio
